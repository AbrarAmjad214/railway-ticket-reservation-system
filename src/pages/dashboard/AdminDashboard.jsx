...
import { Users, Train, Calendar, BookOpen, TrendingUp, DollarSign } from 'lucide-react'
...
const AdminDashboard = ({ user }) => {
  ...
  const fetchAdminData = async () => {
    try {
      const [usersRes, trainsRes, schedulesRes, bookingsRes] = await Promise.all([
        authAPI.getAllUsers(),
        trainAPI.getTrains(),
      ...
      const totalRevenue = bookings.reduce((sum, booking) => {
        return booking.paymentStatus === 'paid' ? sum + (booking.schedule?.ticketPrice || 0) : sum
      }, 0)
                ...
                <div key={booking._id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    <p className="font-medium text-gray-900">
                      {booking.user?.name || 'User'} - {booking.train?.trainName || 'Train'}
                    </p>
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium text-green-900">Manage Trains</span>
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium text-purple-900">Manage Schedules</span>
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium text-orange-900">Manage Bookings</span>
              </div>
